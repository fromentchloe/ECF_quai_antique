        ...
        <form id="scheduleForm" action="./MySQL/change_schedule.php" method="POST">
          ...
          ?>
            ...
            <select name="<?php echo $day; ?>" id="<?php echo $day; ?>">
              ...
              <option value="12h00-13h00 / 19h00-22h00"<?php echo ($value === 'Fermé / 19h00-22h00') ? ' selected' : ''; ?>>Fermé / 19h00-22h00</option>
              <option value="12h00-14h00 / 19h00-22h00"<?php echo ($value === '12h00-14h00 / 19h00-22h00') ? ' selected' : ''; ?>>12h00-14h00 / 19h00-22h00</option>
              <option value="Fermeture Exeptionnelle"<?php echo ($value === 'Fermeture Exeptionnelle') ? ' selected' : ''; ?>>Fermeture Exeptionnelle</option>
            </select>
          <?php } ?>
